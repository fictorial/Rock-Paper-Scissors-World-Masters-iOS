...
-(void) authenticateLocalPlayer
{
    ...
    if (localPlayer.authenticated == NO)
    {
        ...
        [localPlayer authenticateWithCompletionHandler:^(NSError* error)
        {
            ...
            {
                [delegate authenticationFailedWithError:lastError];
            }
        }];
    }
}
...
-(void) retrieveLocalPlayerScoreForCategory:(NSString *)category {
    ...
    [self retrieveScoresForPlayers:[NSArray arrayWithObject:[GKLocalPlayer localPlayer].playerID]
                          category:category 
...
- (void)sendDataToAllPlayers:(NSData *)data 
{
    ...
    NSError* error = nil;
    [currentMatch sendDataToAllPlayers:data withDataMode:GKMatchSendDataReliable error:&error];
    [self setLastError:error];
}
